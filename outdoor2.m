...
orig=imread('outdoor.jpg');
figure, imshow(orig),title('Original');
originfo = imfinfo('outdoor.jpg');
...
figure, imshow(DF2),title('dct2');
 imwrite(DF2,'outdoor_1024DF.jpg');
...
Maximum_Value_of_dct_coeffieient = max(max(dct_transformed_image));
 ...
 dct_transformed_image_coeffieient = dct_transformed_image./Maximum_Value_of_dct_coeffieient;
    ...
    %---------------------------------------------------------------------
    imageresizeinfo = imfinfo('outdoor_1024convert.jpg');
    ...
    fid = fopen('outdoor_Compression_Ratio.txt','wt');
...
%---------------------- Run Level Decoding ---------------------------
    ...
    imwrite(dct_transformed_image_inverse_double,'outdoor_1024ReverseDF.jpg');
    ...
    % restore the compressed image from the given set of coeficients
     ...
     imwrite(restored_image_int,'outdoor_1024reverse.jpg');
